...
public struct TKSimpleSwitchConfig {
    var onColor     : UIColor = UIColor(red:0,  green:0,  blue:0, alpha:1)
    var offColor    : UIColor = UIColor(red:0.84,  green:0.84,  blue:0.84, alpha:1)
    var lineColor   : UIColor = UIColor(red:0.1,  green:0.1,  blue:0.1, alpha:1)
    var circleColor : UIColor = UIColor(red:0.13,  green:0.13,  blue:0.13, alpha:1)
